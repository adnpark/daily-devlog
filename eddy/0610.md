...
Delegate와 DataSource 합쳐서 하위 Controller로 만들기
...
비슷한 목적을 위해 Delegate 뿐만 아니라, Closure 를 쓰는 방법도 있다. 둘 다 그렇게 어렵지 않고 우리가 원하는 바를 달성할 수 있다.

둘 중에 뭘 쓰는 게 좋을까? 고민을 해보자.

(작성중 - 뭘 쓰는 게 좋을까요 맞춰보세요~)
